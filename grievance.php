...
<body>
    ...
    <div class="style3">Grievance/Redressal Officer
    </div><br />
	...
	<table cellspacing="2" cellpadding="3" rules="all" id="ContentPlaceHolder1_GridView1" style="background-color:#DEBA84;border-color:#DEBA84;border-width:1px;border-style:None;font-size:Small;width:616px;">
		<tr style="color:White;background-color:#A55129;font-weight:bold;">
			<th scope="col">Name</th><th scope="col">Email</th><th scope="col">Phone No.</th><th scope="col">Fax No.</th>
		</tr><tr style="color:#8C4510;background-color:#FFF7E7;">
			<td>Ashish Kumar Pradhan</td><td>ramdootedu@gmail.com</td><td>7376832425</td><td>--</td>
		</tr>
	</table>
</div>
                        <br />
