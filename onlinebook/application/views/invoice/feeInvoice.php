...
?>		
		...
		<div id="customer">
            ...
            <table>
                ...
                <tr>
                    <td class="meta-head" style="line-height: 8px;">Date</td>
                    <td style="line-height: 8px;">
                    	<?php 
							echo date("d-M-y", strtotime($rowb->till_diposit));
						?>
					</td>
                </tr>
            </table>
...
<?php $i++; endif; endforeach; ?>		  
          	  				...
          	  				<td rowspan="4" style="width: 75%;padding: 5px;" valign="bottom">
          	  					<table>
          	  						<tr>
          	  							...
          	  							<td style="border:0px;"><?php echo $this->session->userdata("name"); ?></td>
	...
	if($this->uri->segment(5) == "yes"){
		...
		if($val->count1 == "2"):
			if($isAdmission == "true"):
				$msg = "Hi ".$rowc->first_name.". Your Fee of till month ".date("d-M-y", strtotime($rowb->till_diposit))." with Admission fee is diposited of Rs.".$rowb->paid."/- with balance Rs.".$rowb->current_balance."/- . For more information. Please logon to our website : ".$val->web_url;
			else:
				$msg = "Hi ".$rowc->first_name.". Your Fee of till month ".date("d-M-y", strtotime($rowb->till_diposit))." is diposited of Rs.".$rowb->paid."/- with balance Rs.".$rowb->current_balance."/- . For more information. Please logon to our website : ".$val->web_url;
			endif;
					?>
