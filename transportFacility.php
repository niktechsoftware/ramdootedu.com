...
<body>
    ...
    <div class="style3">Transport Facility
    </div><br />
  
    <div>
    <table cellspacing="2" cellpadding="3" rules="all" id="ContentPlaceHolder1_DetailsView1" style="background-color:#DEBA84;border-color:#DEBA84;border-width:1px;border-style:None;font-size:Small;height:50px;width:608px;">
		
			
		<tr style="color:#8C4510;background-color:#FFF7E7;font-weight:bold;">
